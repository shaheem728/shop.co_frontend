                  ...
                  {[...Array(pages)].map((_, i) => {
                    return (
                      <span onClick={() => selectPageHandler(i + 1)} key={i}>
                        <span className={`flex items-center justify-center px-3 h-8 leading-tight ${page === i+1?'text-blue-500':'text-gray-500'} bg-white   hover:bg-gray-100 hover:text-gray-700 `}>
                          {i + 1}
                        </span>
                      </span>
                    );
